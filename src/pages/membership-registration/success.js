...
import { HiCheckCircle } from "react-icons/hi"; // Importing check icon from react-icons
    ...
    <div className="bg-gray-50 flex justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl w-full bg-white shadow-md rounded-lg p-8">
        ...
        <div className="text-center">
          <div className="mb-8">
            <HiCheckCircle className="mx-auto text-green-500 h-24 w-24" />
          </div>
          ...
          <p className="text-gray-600 mb-6">
            Your documents have been verified successfully, you are able to
            continue your membership registration.
          </p>
